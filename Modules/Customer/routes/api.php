...
use Modules\Customer\app\Http\Controllers\AttributeController;
...
Route::middleware(['auth:sanctum'])->prefix('asset')->group(function () {
    ...
    //Value of Asset CRUD
    Route::post('create-value', [AssetController::class, 'store']);
    Route::put('update-value/{id}', [AssetController::class, 'update']);
    Route::delete('delete-value/{id}', [AssetController::class, 'destroy']);
});
